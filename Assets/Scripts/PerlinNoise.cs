...
public class PerlinNoise : MonoBehaviour {
   ...
   void Start()
    ...
    {
        return GeneratePerlinNoise(GenerateWhiteNoise(width, height), octave);
        // for testing
        //return GenerateSmoothNoise(GenerateWhiteNoise(width, height), octave);
    }
    ...
    float[,] GenerateSmoothNoise(float[,] baseNoise, int octave)
    {
        ...
        for (int i = 0; i < width; i++)
        {
            ...
            for (int j = 0; j < height; j++)
            {
                ...
                // for testing
                //smoothNoise[i, j] = baseNoise[sample_i1,sample_j0];
            }
        }
