...
public class TerrainGeneration : MonoBehaviour {
    ...
    public int depth = 15;
    /*
    public float persistence = 0.3f;    // what makes the amplitude shrink
    public int octave = 6;              // how many layers you are putting together
    ...
    */
    ...
    void Start () {
        ...
        noise = noiseGenerator.perlinNoise;
        terrain = GetComponent<Terrain>();
        GenerateTerrain(terrain);
        cactusGenerator.enabled = true;
    ...
    float CalculateHeight(int x, int y)
    {
        ...
        float sample = noise[x, y]; // need write my own perlinnoise
        return sample;
    }
